    ...
    switch ( appData.state )
    {
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            if(appData.emulateMouse)
            {
                ...
                if(movement_length > 50)      //four pieces of data that represent what mouse does
                {
                    acc_setup();
                    short accels[3];
                    acc_read_register(OUT_X_L_A, (unsigned char *) accels, 6);
                    ...
                    //appData.xCoordinate =(int8_t)dir_table[vector & 0x07] ;  //must intialize, read , and scale accelerometer
                    //appData.yCoordinate =(int8_t)dir_table[(vector+2) & 0x07]; //put spi.c and accel.h in source files then include in app.c
                    appData.xCoordinate =-accels[1]/800;
                    appData.yCoordinate =accels[0]/800;
